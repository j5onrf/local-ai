...
| **Subprocess RAG Tool Injection** | Executes local scripts (via `[TOOL]` tags) behind the scenes, feeding their standard output straight into the LLM context for real-time system troubleshooting. |
