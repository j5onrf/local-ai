...
- **NATIVE TOOLS:** Execute operations via native system function calls (`read_symbol`, `trace_symbol`, `blast_radius`, `find_symbol`, `architecture_overview`, `read_file`, `write_file`, `list_dir`, `run_command`). Do NOT write markdown tool blocks.
