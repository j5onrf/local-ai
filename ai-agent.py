#!/usr/bin/env python3
"""Local-Ai Agent [j5onrf] [v0.9.8.51]"""
            ...
            if pending_query:
                ...
                if query == "/tui":
                    ...
                    try:
                        ...
                        tui_env = {**os.environ, "AI_IS_AGENT": "1" if is_agent else "0", "AI_WORKSPACE_PATH": workspace_path, "AI_ACTIVE_SKILL": active_skill_env, "AI_SESSION_HISTORY": json.dumps(chat_history)}
